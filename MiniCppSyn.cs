...
public class MiniCppSyn {
  ...
  private class GrammarTable {
    ...
    public byte[] code = {
       ...
       243,   0,  13,  11,   1,   1, 249,   0,  14,  11,   0,  11,  15,  11,
        ...
        48,   2,  15,   0,  46,  11,   0,  13,  13,   5,  22,  63,   2,   2,
         8,   5,  15,   0,  46,  11,   0,  17,  13,   0,  27,   4,  22,   2,
         0,  28,  15,   0,  31,   5,  20,  91,   2,   4,  17,  10,  82,   2,
         5,  21,  96,   2,   6,   0,  32,  19,  11,   0,  18,  13,   2,  49,
         2,   0,  47,   5,   9, 117,   2,   3,  16,  10, 108,   2,   8,  12,
        17,  11,   0,  19,   0,  47,   4,   9,   1,   5,   9, 136,   2,   2,
        10, 128,   2,   8,   9,  11,   4,  23,   1,  11,   4,  24,   1,  14,
         1,  34, 159,   2,  15,   4,  24,   4,  17,  10, 147,   2,   8,  13,
        11,   4,  25,   1,  14,   1,  35, 178,   2,  15,   4,  25,   4,  17,
        10, 166,   2,   8,  14,  11,   4,  26,   1,  14,   1,  36, 195,   2,
        15,   4,  26,   9,  22,  11,   1,  37, 203,   2,  16,  10, 190,   2,
         1,  38, 211,   2,  17,  10, 190,   2,   1,  39, 219,   2,  18,  10,
       190,   2,   1,  40, 227,   2,  19,  10, 190,   2,   1,  41, 235,   2,
        20,  10, 190,   2,   8,  15,  11,   1,  20,  14,   3,  13,   4,  27,
         3,  16,   1,  20,   3,   3,  17,   4,  27,   7,  20,  10, 247,   2,
         1,  21,  11,   3,  18,  10, 252,   2,   8,  16,  11,   1,  21, 243,
         2,  14,  10, 243,   2,   4,  28,   1,  14,   1,  22,  38,   3,  15,
         4,  28,   6,  19,  10,  26,   3,   1,  23,  46,   3,  16,  10,  31,
         3,   1,  24,  54,   3,  17,  10,  31,   3,   8,  17,  11,   1,  33,
        62,   3,  13,   4,  29,   2,  15,  11,   1,   9,  73,   3,  13,  11,
         1,  14,  79,   3,  14,  11,   3,  49,  86,   3,   3,  16,  11,   3,
        48, 127,   3,   5,  18,   9,  18,  98,   3,  19,  11,   9,  19, 113,
         3,  20,   0,  29,  21,   4,  22,  10,   0,  30,  23,  11,   8,   4,
        24,   0,  27,   5,  11, 123,   3,  13,   0,  28,  26,  11,   1,  12,
       144,   3,  27,   4,   7,  16,   0,  29,   4,  22,  17,   0,  30,  30,
        11,   0,  27,   4,  22,  19,  32,   0,  28,  11,   4,   0,   1,   0,
         0,  11
    };
    public NTData[] nts = {
      ...
      new NTData( 612, false, new Sets.Set256(0x0000, 0x0004)),
      new NTData( 633, false, new Sets.Set256(0x0000, 0x0008)),
      new NTData( 651, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 655, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 674, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 693, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 750, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 790, false, new Sets.Set256(0x5200, 0x0800, 0x0002, 0x0003)),
      new NTData( 825, false, new Sets.Set256(0x5200, 0x0800, 0x0002, 0x0003)),
      new NTData( 835, false, new Sets.Set256(0x5200, 0x0800, 0x0000, 0x0003))
    };
    ...
    public String[] names = {
      ...
      "DeleteStat", "ReturnStat", "SwitchStat", "CaseStat", "DefaultPart",
