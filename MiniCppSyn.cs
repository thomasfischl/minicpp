  ...
  private class GrammarTable {
    ...
    public byte[] code = {
       ...
       243,   0,  13,  11,   1,   1, 249,   0,  14,  11,   0,  11,  15,  11,
        ...
        17,  11,   0,  19,   0,  47,   4,   9,   1,  14,   5,   9, 138,   2,
         3,  16,  10, 129,   2,   8,   9,  11,   4,  23,   1,  11,   4,  24,
         1,  14,   1,  34, 161,   2,  15,   4,  24,   4,  17,  10, 149,   2,
         8,  13,  11,   4,  25,   1,  14,   1,  35, 180,   2,  15,   4,  25,
         4,  17,  10, 168,   2,   8,  14,  11,   4,  26,   1,  14,   1,  36,
       197,   2,  15,   4,  26,   9,  22,  11,   1,  37, 205,   2,  16,  10,
       192,   2,   1,  38, 213,   2,  17,  10, 192,   2,   1,  39, 221,   2,
        18,  10, 192,   2,   1,  40, 229,   2,  19,  10, 192,   2,   1,  41,
       237,   2,  20,  10, 192,   2,   8,  15,  11,   1,  20,  16,   3,  13,
         4,  27,   3,  16,   1,  20,   5,   3,  17,   4,  27,   7,  20,  10,
       249,   2,   1,  21,  13,   3,  18,  10, 254,   2,   8,  16,  11,   1,
        21, 245,   2,  14,  10, 245,   2,   4,  28,   1,  14,   1,  22,  40,
         3,  15,   4,  28,   6,  19,  10,  28,   3,   1,  23,  48,   3,  16,
        10,  33,   3,   1,  24,  56,   3,  17,  10,  33,   3,   8,  17,  11,
         1,  33,  64,   3,  13,   4,  29,   2,  15,  11,   1,   9,  75,   3,
        13,  11,   1,  14,  81,   3,  14,  11,   3,  49,  88,   3,   3,  16,
        11,   3,  48, 129,   3,   5,  18,   9,  18, 100,   3,  19,  11,   9,
        19, 115,   3,  20,   0,  29,  21,   4,  22,  10,   0,  30,  23,  11,
         8,   4,  24,   0,  27,   5,  11, 125,   3,  13,   0,  28,  26,  11,
         1,  12, 146,   3,  27,   4,   7,  16,   0,  29,   4,  22,  17,   0,
        30,  30,  11,   0,  27,   4,  22,  19,  32,   0,  28,  11,   4,   0,
         1,   0,   0,  11
    };
    public NTData[] nts = {
      ...
      new NTData( 653, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 657, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 676, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 695, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 752, false, new Sets.Set256(0x5200, 0x0830, 0x0002, 0x0003)),
      new NTData( 792, false, new Sets.Set256(0x5200, 0x0800, 0x0002, 0x0003)),
      new NTData( 827, false, new Sets.Set256(0x5200, 0x0800, 0x0002, 0x0003)),
      new NTData( 837, false, new Sets.Set256(0x5200, 0x0800, 0x0000, 0x0003))
    };
